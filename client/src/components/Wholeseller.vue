<template>
  <div class="container-fluid">
    ...
    <div id="login">
      ...
      <div class="others">
        <v-btn color="#ef5023" style="color:white;width: 40%;border-radius: 5px; padding: 15px;text-decoration: none" href="#"><strong>REGISTER AS A WHOLESELLER</strong></v-btn><br><br><br>
